...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-6 relative">
            ...
            <script
              ...
              dangerouslySetInnerHTML={{
                ...
                (function() {
                  ...
                  // ... (the full popunder script you sent — it's already included in the previous message, but paste the whole thing here)
      ...
      {/* (keep the panels from the previous code — they are the same) */}
